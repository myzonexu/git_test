...
class CommunicationProtocol(object):
    def __init__(self):
        ...
        self.bat_voltage = SpnData(name = "bat_voltage",addr = 1006,length = 1,rate = 0.01,offset = 0,rw="r")
        ...
        self.rfid = SpnData(name = "rfid",addr = 1010,length = 1,rate = 1,offset = 0,rw="r")
        ...
        self.bat_current = SpnData(name = "bat_current",addr = 1023,length = 1,rate = 0.1,offset = 0,rw="r")
